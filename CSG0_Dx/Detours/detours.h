...
#define _ARg_WINAPI_PARTITION_DESKTOP_SDK_AVAILABLE 1
...
typedef struct _DETOUR_SYg_INFO
{
    HANDLE                  hProcess;
    HMODULE                 hDbgHelp;
...
} DETOUR_SYg_INFO, *PDETOUR_SYg_INFO;

PDETOUR_SYg_INFO DetourLoadImageHlp(VOID);
...
#define Mg_ALLOCATION_GRANULARITY 0x10000
